...
declare namespace Autodesk {
    namespace Viewing {
        ...
        class BubbleNode {
          ...
          getDefaultGeometry(searchMasterview?: boolean, loadLargestView?:boolean): BubbleNode;
        ...
        // ADDED 2022-05-15 for manual refreshToken after gltf load
        function refreshToken(in_tokenStr: string,  successCallback?: () => void, errorCallback?: () => void ): void
        ...
        class Document {
          ...
          // Added by LH at 20/02/2022
          getAcmSessionId(url:string): string;
        }
        ...
        namespace Private {
            ...
            interface FragmentList {
              ...
              //[MISSING FUNCTION]
              setMaterial(fragId: number, material:THREE.Material) :any;
              getDbIds(fragId: number[]):any;
            ...
            class Viewer3DImpl {
                ...
                //[MISSING FUNCTIONS]
                toggleGhosting(ghosting: boolean): any;
                toggleGroundShadow(groundShadow: boolean): any;
                setGhostingBrightness(setGhosting: boolean): any; 
            }
        ...
        namespace UI {
          ...
          class Control {
            ...
            // added to support remove control 
            //removeControl(buttonName: string): any;
